...
public class kafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, CarDto> carDtoConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CarDto> containerFactory(){
        ConcurrentKafkaListenerContainerFactory<String, CarDto> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(carDtoConsumerFactory());
        return factory;
    }
}
